...
public class DataSetTester
{
   public static void main(String[] args)
   {
      ...
      BankAccount max = (BankAccount) bankData.getMaximum();   // Casted to BankAccount object
      ...
      BaseballPlayer maxA = (BaseballPlayer) battingAvgData.getMaximum();  // Casted to BaseballPlayer object
